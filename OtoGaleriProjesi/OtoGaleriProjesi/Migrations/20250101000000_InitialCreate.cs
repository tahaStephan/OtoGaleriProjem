        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YakitTipi = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    Vites = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    SasiNo = table.Column<string>(type: "nvarchar(17)", maxLength: 17, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Satislar_Calisanlar_CalisanId",
